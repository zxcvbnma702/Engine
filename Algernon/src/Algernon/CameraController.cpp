...
namespace Algernon
{
	...
	void OrthographicCameraController::OnUpdate(Timestep ts)
	{
		...
		else if (Algernon::Input::IsKeyPressed(AL_KEY_D))
			m_CameraPosition.x += m_CameraTranslationSpeed * ts;

		if (Algernon::Input::IsKeyPressed(AL_KEY_W))
			m_CameraPosition.y += m_CameraTranslationSpeed * ts;
		else if (Algernon::Input::IsKeyPressed(AL_KEY_S))
			m_CameraPosition.y -= m_CameraTranslationSpeed * ts;

		if (m_Rotation) {

			if (Algernon::Input::IsKeyPressed(AL_KEY_Q))
				m_CameraRotation += m_CameraRotationSpeed * ts;
			if (Algernon::Input::IsKeyPressed(AL_KEY_E))
				m_CameraRotation -= m_CameraRotationSpeed * ts;
