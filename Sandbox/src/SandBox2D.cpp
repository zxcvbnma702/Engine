...
void SandBox2D::OnUpdate(Algernon::Timestep ts)
{
	...
	
	{
		...
		Algernon::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckerboardTexture, 10.0f);
		Algernon::Renderer2D::DrawRotatedQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, rotation,  m_CheckerboardTexture, 20.0f);
